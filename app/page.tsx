    ...
    <div className="select-none">
      <main className="w-full h-screen p-4 flex flex-col items-center justify-center gap-4">
        <PerspectiveCard maxAngleX={20} maxAngleY={40} perspective={1000}>
          <div className="starting:opacity-0 opacity-100 delay-500 transition-opacity duration-2000">
            <h1 className="group text-5xl sm:text-7xl lg:text-9xl text-center font-bold bg-linear-to-t from-neutral-900 to-white bg-clip-text text-transparent transition-all cursor-help">
              <span className="text-sky-500 sm:text-transparent starting:text-transparent group-hover:text-sky-500 transition-colors delay-3000 sm:delay-0 hover:delay-0 duration-1000">lost</span>
              {' and '}
              <span className='text-lime-500 sm:text-transparent starting:text-transparent group-hover:text-lime-500 transition-colors delay-3500 sm:delay-0 hover:delay-500 duration-1000'>found</span>
            </h1>
          </div>
        </PerspectiveCard>
        <section className="text-center text-balance font-mono starting:opacity-0 opacity-100 delay-1500 transition-opacity duration-2000">
          ...
          <p>inquire to <Link className="text-yellow-500 hover:animate-pulse font-black" href={"mailto:found@devalto.dev"}>found@devalto.dev</Link> to commence the reprocurement process.</p>
        </section>
      </main>
      ...
      <section className="pointer-events-none">
        ...
        <div className="starting:opacity-0 opacity-100 transition-all duration-3000 delay-2500">
          <div className="-z-10 absolute top-0 w-full h-[99%] outline-white outline-10 outline-dashed starting:scale-100 scale-80 transition-all duration-5000 opacity-0 sm:opacity-5" />
