...
export default function Home() {
  return (
    <div>
      ...
      <section className="starting:opacity-0 opacity-100 delay-2500 transition-all duration-3000">
        <video src={"/assets/backdrop.webm"} className="absolute top-0 w-full h-full object-cover opacity-15 pointer-events-none" autoPlay loop muted></video>
